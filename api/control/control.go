...
func init() {
	option.RegisterHandler(&apiController{
		cmd:                flag.String("api", "", "Connect to a Trojan-Go API service. \"-api set/get/list/record\""),		address:            flag.String("api-addr", "127.0.0.1:10000", "Address of Trojan-Go API service"),
