...
type GetRecordsRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Transport      string                 `protobuf:"bytes,1,opt,name=transport,proto3" json:"transport,omitempty"` // UDP, TCP
...
type GetRecordsResponse struct {
	...
	TargetPort    string                 `protobuf:"bytes,6,opt,name=target_port,json=targetPort,proto3" json:"target_port,omitempty"`
...
type SetOutboundConfigRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LocalAddr     string                 `protobuf:"bytes,1,opt,name=local_addr,json=localAddr,proto3" json:"local_addr,omitempty"`
	Fwmark        int32                  `protobuf:"varint,2,opt,name=fwmark,proto3" json:"fwmark,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetOutboundConfigRequest) Reset() {
	*x = SetOutboundConfigRequest{}
	mi := &file_api_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetOutboundConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetOutboundConfigRequest) ProtoMessage() {}

func (x *SetOutboundConfigRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetOutboundConfigRequest.ProtoReflect.Descriptor instead.
func (*SetOutboundConfigRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{14}
}

func (x *SetOutboundConfigRequest) GetLocalAddr() string {
	if x != nil {
		return x.LocalAddr
	}
	return ""
...
func (x *SetOutboundConfigRequest) GetFwmark() int32 {
	if x != nil {
		return x.Fwmark
	}
	return 0
...
type SetOutboundConfigResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Info          string                 `protobuf:"bytes,2,opt,name=info,proto3" json:"info,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *SetOutboundConfigResponse) Reset() {
	*x = SetOutboundConfigResponse{}
	mi := &file_api_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetOutboundConfigResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetOutboundConfigResponse) ProtoMessage() {}

func (x *SetOutboundConfigResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetOutboundConfigResponse.ProtoReflect.Descriptor instead.
func (*SetOutboundConfigResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{15}
}

func (x *SetOutboundConfigResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SetOutboundConfigResponse) GetInfo() string {
	if x != nil {
		return x.Info
	}
	return ""
...
type GetOutboundConfigRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetOutboundConfigRequest) Reset() {
	*x = GetOutboundConfigRequest{}
	mi := &file_api_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOutboundConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOutboundConfigRequest) ProtoMessage() {}

func (x *GetOutboundConfigRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOutboundConfigRequest.ProtoReflect.Descriptor instead.
func (*GetOutboundConfigRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{16}
}

type GetOutboundConfigResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LocalAddr     string                 `protobuf:"bytes,1,opt,name=local_addr,json=localAddr,proto3" json:"local_addr,omitempty"`
	Fwmark        int32                  `protobuf:"varint,2,opt,name=fwmark,proto3" json:"fwmark,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *GetOutboundConfigResponse) Reset() {
	*x = GetOutboundConfigResponse{}
	mi := &file_api_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOutboundConfigResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOutboundConfigResponse) ProtoMessage() {}

func (x *GetOutboundConfigResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOutboundConfigResponse.ProtoReflect.Descriptor instead.
func (*GetOutboundConfigResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{17}
}

func (x *GetOutboundConfigResponse) GetLocalAddr() string {
	if x != nil {
		return x.LocalAddr
	}
	return ""
...
func (x *GetOutboundConfigResponse) GetFwmark() int32 {
	if x != nil {
		return x.Fwmark
	}
	return 0
...
const file_api_proto_rawDesc = "" +
	...
	"trojan.api\"[\n" +
	"\aTraffic\x12%\n" +
	"\x0eupload_traffic\x18\x01 \x01(\x04R\ruploadTraffic\x12)\n" +
	"\x10download_traffic\x18\x02 \x01(\x04R\x0fdownloadTraffic\"Q\n" +
	"\x05Speed\x12!\n" +
	"\fupload_speed\x18\x01 \x01(\x04R\vuploadSpeed\x12%\n" +
	"\x0edownload_speed\x18\x02 \x01(\x04R\rdownloadSpeed\"6\n" +
	"\x04User\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\x12\x12\n" +
	"\x04hash\x18\x02 \x01(\tR\x04hash\"\x92\x02\n" +
	"\n" +
	"UserStatus\x12$\n" +
	"\x04user\x18\x01 \x01(\v2\x10.trojan.api.UserR\x04user\x128\n" +
	"\rtraffic_total\x18\x02 \x01(\v2\x13.trojan.api.TrafficR\ftrafficTotal\x126\n" +
	"\rspeed_current\x18\x03 \x01(\v2\x11.trojan.api.SpeedR\fspeedCurrent\x122\n" +
	"\vspeed_limit\x18\x04 \x01(\v2\x11.trojan.api.SpeedR\n" +
	"speedLimit\x12\x1d\n" +
	"\n" +
	"ip_current\x18\x05 \x01(\x05R\tipCurrent\x12\x19\n" +
	"\bip_limit\x18\x06 \x01(\x05R\aipLimit\"9\n" +
	"\x11GetTrafficRequest\x12$\n" +
	"\x04user\x18\x01 \x01(\v2\x10.trojan.api.UserR\x04user\"\xb4\x01\n" +
	"\x12GetTrafficResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x12\n" +
	"\x04info\x18\x02 \x01(\tR\x04info\x128\n" +
	"\rtraffic_total\x18\x03 \x01(\v2\x13.trojan.api.TrafficR\ftrafficTotal\x126\n" +
	"\rspeed_current\x18\x04 \x01(\v2\x11.trojan.api.SpeedR\fspeedCurrent\"\x12\n" +
	"\x10ListUsersRequest\"C\n" +
	"\x11ListUsersResponse\x12.\n" +
	"\x06status\x18\x01 \x01(\v2\x16.trojan.api.UserStatusR\x06status\"7\n" +
	"\x0fGetUsersRequest\x12$\n" +
	"\x04user\x18\x01 \x01(\v2\x10.trojan.api.UserR\x04user\"p\n" +
	"\x10GetUsersResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x12\n" +
	"\x04info\x18\x02 \x01(\tR\x04info\x12.\n" +
	"\x06status\x18\x03 \x01(\v2\x16.trojan.api.UserStatusR\x06status\"\xb4\x01\n" +
	"\x0fSetUsersRequest\x12.\n" +
	"\x06status\x18\x01 \x01(\v2\x16.trojan.api.UserStatusR\x06status\x12C\n" +
	"\toperation\x18\x02 \x01(\x0e2%.trojan.api.SetUsersRequest.OperationR\toperation\",\n" +
	"\tOperation\x12\a\n" +
	"\x03Add\x10\x00\x12\n" +
	"\n" +
	...
	"\n" +
	"\x06Modify\x10\x02\"@\n" +
	"\x10SetUsersResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x12\n" +
	"\x04info\x18\x02 \x01(\tR\x04info\"{\n" +
	"\x11GetRecordsRequest\x12\x1c\n" +
	"\ttransport\x18\x01 \x01(\tR\ttransport\x12\x1f\n" +
	"\vtarget_port\x18\x02 \x01(\tR\n" +
	"targetPort\x12'\n" +
	"\x0finclude_payload\x18\x03 \x01(\bR\x0eincludePayload\"\x87\x02\n" +
	"\x12GetRecordsResponse\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\tR\ttimestamp\x12\x1b\n" +
	"\tuser_hash\x18\x02 \x01(\tR\buserHash\x12\x1b\n" +
	"\tclient_ip\x18\x03 \x01(\tR\bclientIp\x12\x1f\n" +
	"\vclient_port\x18\x04 \x01(\tR\n" +
	"clientPort\x12\x1f\n" +
	"\vtarget_host\x18\x05 \x01(\tR\n" +
	"targetHost\x12\x1f\n" +
	"\vtarget_port\x18\x06 \x01(\tR\n" +
	"targetPort\x12\x1c\n" +
	"\ttransport\x18\a \x01(\tR\ttransport\x12\x18\n" +
	"\apayload\x18\b \x01(\fR\apayload\"Q\n" +
	"\x18SetOutboundConfigRequest\x12\x1d\n" +
	"\n" +
	"local_addr\x18\x01 \x01(\tR\tlocalAddr\x12\x16\n" +
	"\x06fwmark\x18\x02 \x01(\x05R\x06fwmark\"I\n" +
	"\x19SetOutboundConfigResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x12\n" +
	"\x04info\x18\x02 \x01(\tR\x04info\"\x1a\n" +
	"\x18GetOutboundConfigRequest\"R\n" +
	"\x19GetOutboundConfigResponse\x12\x1d\n" +
	"\n" +
	"local_addr\x18\x01 \x01(\tR\tlocalAddr\x12\x16\n" +
	"\x06fwmark\x18\x02 \x01(\x05R\x06fwmark2d\n" +
	"\x13TrojanClientService\x12M\n" +
	"\n" +
	"GetTraffic\x12\x1d.trojan.api.GetTrafficRequest\x1a\x1e.trojan.api.GetTrafficResponse\"\x002\x96\x04\n" +
	"\x13TrojanServerService\x12L\n" +
	"\tListUsers\x12\x1c.trojan.api.ListUsersRequest\x1a\x1d.trojan.api.ListUsersResponse\"\x000\x01\x12K\n" +
	"\bGetUsers\x12\x1b.trojan.api.GetUsersRequest\x1a\x1c.trojan.api.GetUsersResponse\"\x00(\x010\x01\x12K\n" +
	"\bSetUsers\x12\x1b.trojan.api.SetUsersRequest\x1a\x1c.trojan.api.SetUsersResponse\"\x00(\x010\x01\x12O\n" +
	"\n" +
	"GetRecords\x12\x1d.trojan.api.GetRecordsRequest\x1a\x1e.trojan.api.GetRecordsResponse\"\x000\x01\x12b\n" +
	"\x11SetOutboundConfig\x12$.trojan.api.SetOutboundConfigRequest\x1a%.trojan.api.SetOutboundConfigResponse\"\x00\x12b\n" +
	"\x11GetOutboundConfig\x12$.trojan.api.GetOutboundConfigRequest\x1a%.trojan.api.GetOutboundConfigResponse\"\x00B2Z0github.com/Potterli20/trojan-go-fork/api/serviceb\x06proto3"
...
var file_api_proto_goTypes = []any{
	...
	(*GetRecordsRequest)(nil),         // 13: trojan.api.GetRecordsRequest
	(*GetRecordsResponse)(nil),        // 14: trojan.api.GetRecordsResponse
	(*SetOutboundConfigRequest)(nil),  // 15: trojan.api.SetOutboundConfigRequest
	(*SetOutboundConfigResponse)(nil), // 16: trojan.api.SetOutboundConfigResponse
	(*GetOutboundConfigRequest)(nil),  // 17: trojan.api.GetOutboundConfigRequest
	(*GetOutboundConfigResponse)(nil), // 18: trojan.api.GetOutboundConfigResponse
}
var file_api_proto_depIdxs = []int32{
	...
	13, // 16: trojan.api.TrojanServerService.GetRecords:input_type -> trojan.api.GetRecordsRequest
	15, // 17: trojan.api.TrojanServerService.SetOutboundConfig:input_type -> trojan.api.SetOutboundConfigRequest
	17, // 18: trojan.api.TrojanServerService.GetOutboundConfig:input_type -> trojan.api.GetOutboundConfigRequest
	...
	14, // 23: trojan.api.TrojanServerService.GetRecords:output_type -> trojan.api.GetRecordsResponse
	16, // 24: trojan.api.TrojanServerService.SetOutboundConfig:output_type -> trojan.api.SetOutboundConfigResponse
	18, // 25: trojan.api.TrojanServerService.GetOutboundConfig:output_type -> trojan.api.GetOutboundConfigResponse
