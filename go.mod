...
require (
	...
	github.com/Potterli20/sqlite v0.0.0-20241118210729-63cf4a0e9d2e
...
require (
	...
	github.com/sagernet/sing-tun v0.6.0-alpha.10 // indirect
	github.com/sagernet/wireguard-go v0.0.1-beta.2 // indirect
