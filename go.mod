...
require (
	github.com/Potterli20/go-shadowsocks2 v0.0.0-20220830123418-76c4c8da1ba5
	github.com/Potterli20/sqlite v0.0.0-20220830122121-ddbd388b95a8
...
require (
	...
	modernc.org/libc v1.17.2 // indirect
