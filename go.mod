...
require (
	...
	github.com/Potterli20/sqlite v0.0.0-20240605012503-00d6658c1189
...
require (
	...
	github.com/sagernet/sing-dns v0.3.0-beta.1 // indirect
	github.com/sagernet/sing-tun v0.3.0 // indirect
